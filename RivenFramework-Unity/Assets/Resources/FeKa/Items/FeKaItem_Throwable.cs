...
[System.Serializable]
public class FeKaItem_Throwable : ItemBehaviour
{
    #region========================================( Variables )======================================================//
    /*-----[ Inspector Variables ]------------------------------------------------------------------------------------*/
    ...
    {
        return new FeKaItem_Throwable
        {
            maxAmmo = this.maxAmmo,
            throwablePrefab = this.throwablePrefab,
    ...
    public override bool OnPickup(FeKaPawn pawn)
    {
        ...
        // Picking up ammo
        if (stats.utility != null && stats.utility.itemBehaviour is FeKaItem_Throwable existingGun)
        {
    ...
    public override void OnUseReleased(FeKaPawn pawn)
    {
        ...
        // Fire
        NetSpawner.Spawn(throwablePrefab.name, spawnPos, spawnRot, (rocketObject, networkId) =>
        {

            var homing = rocketObject.GetComponentInChildren<Throwable>();
            if (homing != null)
            {
